;;; semi-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(register-definition-prefixes "mime-edit" '("eliminate-top-spaces" "mime-" "replace-space-with-underline"))
...
(register-definition-prefixes "mime-image" '("mime-"))
...
(register-definition-prefixes "mime-mac" '("mime-mac-save-and-play-with-"))
...
(register-definition-prefixes "mime-partial" '("mime-combine-message/partial-pieces-automatically"))
...
(register-definition-prefixes "mime-pgp" '("mime-"))
...
(register-definition-prefixes "mime-play" '("mime-"))
...
(register-definition-prefixes "mime-shr" '("mime-shr-"))
...
(register-definition-prefixes "mime-signature" '("mime-edit-"))
...
(register-definition-prefixes "mime-tnef" '("mime-"))
...
(register-definition-prefixes "mime-vcard" '("mime-display-text/vcard"))
...
(register-definition-prefixes "mime-view" '("mime-" "mouse-button-"))
...
(register-definition-prefixes "mime-w3" '("mime-" "url-cid"))
...
(register-definition-prefixes "semi-def" '("mime-"))
...
(register-definition-prefixes "semi-setup" '("call-after-loaded" "mime-setup-"))
...
(register-definition-prefixes "signature" '("insert-signature" "signature"))
