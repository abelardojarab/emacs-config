...
;;;***

;;;### (autoloads nil "dirvish-advices" "dirvish-advices.el" (0 0
;;;;;;  0 0))
;;; Generated autoloads from dirvish-advices.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dirvish-advices" '("dirvish-")))

;;;***

;;;### (autoloads nil "dirvish-builder" "dirvish-builder.el" (0 0
;;;;;;  0 0))
;;; Generated autoloads from dirvish-builder.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dirvish-builder" '("dirvish-")))

;;;***

;;;### (autoloads nil "dirvish-commands" "dirvish-commands.el" (0
;;;;;;  0 0 0))
;;; Generated autoloads from dirvish-commands.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dirvish-commands" '("dirvish-")))

;;;***

;;;### (autoloads nil "dirvish-core" "dirvish-core.el" (0 0 0 0))
;;; Generated autoloads from dirvish-core.el

(autoload 'dirvish-define-attribute "dirvish-core" "\
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dirvish-core" '("dirvish-")))
...
;;;***

;;;### (autoloads nil "dirvish-helpers" "dirvish-helpers.el" (0 0
;;;;;;  0 0))
;;; Generated autoloads from dirvish-helpers.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dirvish-helpers" '("dirvish-")))
...
;;;***

;;;### (autoloads nil "dirvish-options" "dirvish-options.el" (0 0
;;;;;;  0 0))
;;; Generated autoloads from dirvish-options.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dirvish-options" '("dirvish-")))
...
;;;***

;;;### (autoloads nil "dirvish-preview" "dirvish-preview.el" (0 0
;;;;;;  0 0))
;;; Generated autoloads from dirvish-preview.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dirvish-preview" '("dirvish-")))
...
(autoload 'dirvish-yank-display-progress "dirvish-yank" "\
Display yank progress in dirvish footer." nil nil)
