...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "lsp-mode" '("flymake-diagnostic-functions" "lsp-" "make-lsp-client" "when-lsp-workspace" "with-lsp-workspace")))
