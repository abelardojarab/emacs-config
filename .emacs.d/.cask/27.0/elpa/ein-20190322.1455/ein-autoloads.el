...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ob-ein" '("org-babel-default-header-args:ein" "ob-ein-" "ein:org-register-lang-mode" "*ob-ein-sentinel*")))
