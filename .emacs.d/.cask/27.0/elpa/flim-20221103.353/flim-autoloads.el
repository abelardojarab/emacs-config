;;; flim-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(register-definition-prefixes "eword-decode" '("eword-" "mime-"))
...
(register-definition-prefixes "eword-encode" '("ew-" "eword-" "make-ew-rword" "mime-header-" "tm-eword::"))
...
(register-definition-prefixes "hmac-sha1" '("hmac-sha1" "sha1-binary"))
...
(register-definition-prefixes "luna" '("luna-"))
...
(register-definition-prefixes "lunit" '("lunit"))
...
(register-definition-prefixes "md5" '("md5-dl-module"))
...
(register-definition-prefixes "mel" '("7bit-" "8bit-" "Q-encod" "base64-encoded-length" "binary-" "encoded-text-encode-string" "mel-" "mime-encoding-"))
...
(register-definition-prefixes "mel-g" '("gzip64-external-"))
...
(register-definition-prefixes "mel-q" '("q-encoding-" "quoted-printable-"))
...
(register-definition-prefixes "mel-q-ccl" '("mel-ccl-" "q-encoding-ccl-" "quoted-printable-ccl-"))
...
(register-definition-prefixes "mel-u" '("uuencode-external-"))
...
(register-definition-prefixes "mime" '("mime-"))
...
(register-definition-prefixes "mime-conf" '("mime-mailcap-"))
...
(register-definition-prefixes "mime-def" '("B-encoded-text-regexp" "Q-encoded-text-regexp" "base64-" "make-mime-content-" "mel-" "mime-" "quoted-printable-" "regexp-"))
...
(register-definition-prefixes "mime-parse" '("mime-"))
...
(register-definition-prefixes "mmbuffer" '("mmbuffer-parse-"))
...
(register-definition-prefixes "mmexternal" '("mmexternal-require-"))
...
(register-definition-prefixes "mmgeneric" '("mime-" "mm-"))
...
(register-definition-prefixes "qmtp" '("qmtp-"))
...
(register-definition-prefixes "sasl-scram" '("sasl-scram-md5-"))
...
(register-definition-prefixes "sasl-xoauth2" '("sasl-xoauth2-"))
...
(register-definition-prefixes "sha1" '("sha1-dl-module"))
...
(register-definition-prefixes "smtp" '("smtp-"))
...
(register-definition-prefixes "std11" '("std11-"))
