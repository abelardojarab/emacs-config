...
If called interactively, enable Ergoemacs mode if ARG is positive, and
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ergoemacs-theme-engine" '("describe-ergoemacs-theme" "ergoemacs-")))
