...
If called interactively, enable Smart-Tab mode if ARG is positive, and
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "smart-tab" '("smart-tab-")))
