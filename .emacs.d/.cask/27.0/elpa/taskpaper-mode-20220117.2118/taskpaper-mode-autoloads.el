;;; taskpaper-mode-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
Promt for query string and build agenda view." t nil)

(autoload 'taskpaper-agenda-select "taskpaper-mode" "\
Promts for query selection and build agenda view." t nil)

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "taskpaper-mode" '("taskpaper-")))
