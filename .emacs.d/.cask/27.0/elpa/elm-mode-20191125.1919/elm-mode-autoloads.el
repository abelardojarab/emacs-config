...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "elm-font-lock" '("elm-" "turn-on-elm-font-lock")))
...
If called interactively, enable Elm-Indent mode if ARG is positive, and
