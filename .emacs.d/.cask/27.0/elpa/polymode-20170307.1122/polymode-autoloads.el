...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "poly-noweb" '("pm-" "poly-noweb-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "polymode-compat" '("*span*" "pm-" "polymode-switch-buffer-keep-evil-state-maybe")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "polymode-export" '("pm-" "polymode-")))
