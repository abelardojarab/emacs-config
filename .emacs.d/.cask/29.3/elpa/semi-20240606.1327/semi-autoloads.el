;;; semi-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
Unconditionally turn on MIME-Edit mode." t)
...
(fn &optional NOT-DECODE-TEXT NO-SEPARATOR NOT-TURN-ON)" t)
...
(fn &optional IGNORE-EXAMPLES MODE)" t)
...
(fn &optional RAW-BUFFER PREVIEW-BUFFER MOTHER DEFAULT-KEYMAP-OR-FUNCTION REPRESENTATION-TYPE)" t)
(register-definition-prefixes "mime-view" '("access-type" "body" "header" "mime-" "mouse-button-"))
