...
(register-definition-prefixes "ecb-compatibility" '("Electric-pop-up-window" "bs-show" "ecb-" "electric-command-history" "master-says" "one-window-p" "scroll-all-function-all" "tmm-prompt" "view-mode-exit"))
