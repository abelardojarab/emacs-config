...
`Imagex-Sticky mode' mode.  If the prefix argument is positive, enable
...
evaluate the variable `imagex-sticky-mode'.
...
`Imagex-Auto-Adjust mode' mode.  If the prefix argument is positive,
