;;; magic-latex-buffer-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
`Magic-Latex-Buffer mode' mode.  If the prefix argument is positive,
...
evaluate the variable `magic-latex-buffer'.
...
(provide 'magic-latex-buffer-autoloads)
