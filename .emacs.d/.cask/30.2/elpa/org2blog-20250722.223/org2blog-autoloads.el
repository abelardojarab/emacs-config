...
Use either `org2blog-buffer-post-view' or `org2blog-buffer-page-view'.
  ...
  WordPress just doesn't work that way with the API now." t)
...
This is a minor mode.  If called interactively, toggle the `Org2blog/Wp
...
evaluate the variable `org2blog/wp-mode'.
