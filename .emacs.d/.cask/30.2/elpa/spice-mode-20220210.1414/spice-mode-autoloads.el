;;; spice-mode-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
\\{spice-mode-map}
" t)
(register-definition-prefixes "spice-mode" '("spice-"))

;;; End of scraped data

(provide 'spice-mode-autoloads)
