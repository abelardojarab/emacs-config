...
(defconst quack-cvsid "$Id: quack.el,v 1.1 2010/11/21 15:02:51 vrayapp Exp $")
...
(defface  quack-pltish-defn-face
  '((((class color) (background light)) (:bold t :foreground "blue4"))
    (((class color) (background dark))  (:bold t :foreground "blue4" :background "gray60" :height 160 :italic t))
