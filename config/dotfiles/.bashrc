...
export PYTHONPATH=${HOME}/workspace/pythonlibs/lib/python2.7/site-packages
...
export PATH=$MMSIM_ROOT/tools/bin:$MMSIM_ROOT/tools/spectre/bin:$CDS_ROOT/tools/bin:$CDS_ROOT/tools/dfII/bin:/opt/cds/soc710/bin:/opt/synopsys/starrc/2012.12/bin:/opt/synopsys/hspice/Z-2007.03/hspice/linux:/opt/synopsys/cosmosscope/H-2012.12/ai_bin:/opt/mentor/modelsim/6.5f/modeltech/bin:/opt/mentor/calibre/2007.1_17.18/bin:/opt/PyCharm/4.0.6/bin:/opt/IBM/SPSS/Statistics/22/bin:/opt/synopsys/icweb/G-2012.06-SP1/bin/amd64:/opt/synopsys/icvalidator/H-2013.06/bin/SUSE.64:/opt/MATLAB/R2012b/bin:$PYTHONPATH/bin:$PATH:~/workspace/frametools/bin
