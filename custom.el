...
(custom-set-variables
 ...
 '(company-box-doc-delay 0.3 t)
 '(company-box-max-candidates 50 t)
 ...
 '(custom-enabled-themes (quote (vscdark)))
 '(custom-safe-themes
   (quote
...
;; then enter the text in that file's own buffer.")
 '(ispell-choices-win-default-height 5 nil nil "Customized with use-package ispell")
 '(ispell-highlight-face (quote flyspell-incorrect) nil nil "Customized with use-package ispell")
 '(ispell-silently-savep t nil nil "Customized with use-package ispell")
