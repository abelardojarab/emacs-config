...
(custom-set-variables
 ...
 '(auto-revert-check-vc-info t t)
 '(auto-revert-interval 2 t)
 '(auto-revert-verbose nil t nil "Customized with use-package autorevert")
 ...
 '(c-basic-offset 4)
 '(calendar-mark-diary-entries-flag t t nil "Customized with use-package appt")
 '(calendar-set-date-style (quote iso) t)
 '(calendar-today-marker (quote calendar-today-face) t)
 '(calendar-view-diary-initially-flag t t)
 ...
 '(ecb-compile-window-width (quote edit-window) nil nil "Customized with use-package ecb")
 '(ecb-eshell-fit-window-to-command-output nil nil nil "Customized with use-package ecb")
 '(ecb-fix-window-size (quote width) nil nil "Customized with use-package ecb")
 '(ecb-highlight-tag-with-point-delay 180 nil nil "Customized with use-package ecb")
 '(ecb-history-make-buckets (quote mode) nil nil "Customized with use-package ecb")
 '(ecb-kill-buffer-clears-history (quote auto) nil nil "Customized with use-package ecb")
 '(ecb-layout-name "left11" nil nil "Customized with use-package ecb")
 '(ecb-options-version "2.50")
 '(ecb-show-sources-in-directories-buffer (quote always) nil nil "Customized with use-package ecb")
 '(ecb-source-path
   (quote
 ...
 '(ediff-split-window-function (quote split-window-horizontally) t nil "Customized with use-package ediff")
 '(ediff-window-setup-function (quote ediff-setup-windows-plain) t nil "Customized with use-package ediff")
 ...
 '(global-auto-revert-non-file-buffers t t nil "Customized with use-package autorevert")
